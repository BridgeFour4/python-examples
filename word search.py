...
attempts=0
print("Python Terms")
puzzle = ("fjvfloatdyyopxedninsmspfycnnalxeaeeukgeislufryprlcabeeiagcoibuclqttbongojlivxobgadmyahgerjstringwvrs")
def display_puzzle():
    print(puzzle[0:10])
    print(puzzle[10:20])
    print(puzzle[20:30])
...
print("word list")
word_list="float, while, if, boolean, bouble, operators, string, slicing, index"
print(word_list)
print()
